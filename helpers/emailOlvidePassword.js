                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                               ...
                                               <tr>
                                                  <td style="font-size:40px; font-weight: 400; color: #ffffff; text-align:center;">
                                                     ...
                                                     Hola <strong>${nombre}</strong> Has solicitado cambiar tu password
                                                     <br>
                                                  </td>
                                               </tr>
                                               <tr>
                                                  ...
                                                  <td style="text-align:center; margin:0 auto;">
                                                     ...
                                                     <table align="center">
                                                        <tr>
                                                           <td>
                                                              <div>
                                                                 <a href="${process.env.FRONTEND_URL}/olvido-password/${token}" style="background-color:#80c97a;border:1px solid #80c97a;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;border-radius: 10px">Reestablecer Password</a>
                                                              </div>
                                                           </td>
                                                        </tr>
                                                     </table>
